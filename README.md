# Gia Consulting Site (PRO)

Upgrades included:
1) **Sticky nav + Mobile menu**
2) **Design System polish** (spacing, cards, pills, stats, sections)
3) **Smooth scroll** for internal links/CTAs

## Add images
Put your generated images here:

- `img/hero.jpg`
- `img/gap.jpg`
- `img/before-after.jpg`

Then open `index.html` or deploy with GitHub Pages.


## SEO Add-ons included
